...
export default function PrivacyPolicy() {
    ...
    return (
        <div className="container mx-auto my-24 px-3">
            ...
            {/* Helmet */}
            <Helmet>
                <title> {`${SeoData?.privacyPolicyTitle}`}</title>
                <meta name="description" content={SeoData?.privacyPolicyDescription} />
            </Helmet>
            ...
            <div className="bg-secondary_color text-sm rounded-lg px-4 py-2">
                ...
                <span className="font-medium cursor-pointer"> سياسة الخصوصية</span>
            </div>

            <div className="mt-10">
                <p className="font-medium text-xl">سياسة الخصوصية</p>
